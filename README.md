...
You can pass a list of AMIs to use with `cluster_amis`, or use the latest based on your Kubernetes version and AMI type with `ami_type` and `kubernetes_version`.
